...
test('reports missing ## Inputs section in SKILL.md', () => {
  ...
  expect(result.errors.join('\n')).toContain('Skill is missing required section "## Inputs"');
});

test('reports missing ## Outputs section in SKILL.md', () => {
  ...
  expect(result.errors.join('\n')).toContain('Skill is missing required section "## Outputs"');
});

test('reports missing ## Halt Conditions section in SKILL.md', () => {
  ...
  expect(result.errors.join('\n')).toContain('Skill is missing required section "## Halt Conditions"');
});
...
test('reports SKILL.md sections out of template order', () => {
